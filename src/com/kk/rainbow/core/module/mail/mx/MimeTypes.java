...
public class MimeTypes {
	...
	public static String setMimeType(String paramString1, String paramString2) {
		Object localObject = mimeTypes.put(paramString1.toLowerCase(),
				paramString2);
		return localObject == null ? getMimeType("*") : (String) localObject;
	}

	public static String getMimeType(String paramString) {
		Object localObject = mimeTypes.get(paramString.toLowerCase());
		return localObject == null ? getMimeType("*") : (String) localObject;
	}
